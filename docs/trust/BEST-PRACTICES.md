...
| Build and automated tests    | pnpm flux check, unit tests, Chromium behavior and axe, perf/size gates | Link actual passing runs for the assessed commit; review coverage and whether requirements are exercised. Do not invent a coverage percentage.                                             |
