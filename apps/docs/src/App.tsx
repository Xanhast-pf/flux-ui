          ...
          <header>
            <Stack gap="md">
              ...
              <div>
                ...
                <p className="lede">
                  A living view of the design system: repository health, bundle
                  budgets, runtime benchmarks, components, engineering rules,
                  onboarding, and design tokens.
                </p>
              </div>
          ...
          <section id="health">
            <Stack gap="md">
              <div>
                ...
                <p>
                  This page reads committed size and performance baselines
                  generated from the repository. For the live CI result, use the
                  Actions badge above.
                </p>
              </div>
          ...
          <section id="size">
            <Stack gap="md">
              <div>
                ...
                <p>
                  Every public component has an absolute complexity-class budget
                  and a historical regression baseline. The meters below show
                  Brotli size against each component&apos;s absolute budget.
                </p>
              </div>
          ...
          <section id="performance">
            <Stack gap="lg">
              <div>
                ...
                <p>
                  Playwright runs Chromium benchmarks against equivalent native
                  React implementations. CI gates synchronous mount, update, and
                  unmount ratios; next-frame measurements remain diagnostics.
                </p>
              </div>
          ...
          <section id="components">
            <Stack gap="lg">
              <div>
                <h2>Components</h2>
                <p>
                  Flux documents Flux with Flux. These examples are rendered by
                  the same public components consumers import from
              ...
              <Grid minColumnWidth="20rem" gap="md">
                ...
                <ShowcaseCard
                  title="Inline"
                  description="Horizontal groups that can align, distribute, and wrap content."
                >
                  <Inline
                    gap="sm"
                    justify="between"
            ...
            <Stack gap="md">
              ...
              <ol>
                <li>
                  ...
                  complexity instead of forcing casts, workarounds, or framework
                  trivia on consumers.
                </li>
                <li>
                  <strong>Native semantics first.</strong> Extend the platform
                ...
                <li>
                  <strong>Accessibility is not optional.</strong> Components and
                  the docs app are tested with semantic, keyboard, and automated
                  accessibility checks.
                </li>
                <li>
                  <strong>Generated infrastructure stays deterministic.</strong>{" "}
          ...
          <section id="install">
            <Stack gap="md">
              <div>
                ...
                <p>
                  Flux UI is still alpha and not yet presented as a stable
                  public package. To work on the repository:
                </p>
              </div>
...
pnpm size:update`}</code>
          ...
          <section id="tokens">
            <Stack gap="md">
              <div>
                <h2>Design tokens</h2>
                <p>
                  Active theme: <strong>{theme}</strong>. Toggle the theme at
                  the top of the page to inspect both semantic palettes.
                </p>
              </div>
          ...
          <footer>
            <p>
              ...
              truthful project data and documentation structure over visual
              polish.
            </p>
          </footer>
        </Stack>
